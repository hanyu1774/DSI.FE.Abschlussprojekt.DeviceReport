    ...
    if not data:
        ...
        streamlit.altair_chart(
            charts.ranked_bar_chart(
                ...
                single_color=PALETTE[ColorToken.ORANGE], value_title="Anzahl Fehler-Events", bar_height=30,
            )
        )
        streamlit.dataframe(
            df,
    ...
    if not data:
        ...
        streamlit.altair_chart(
            charts.ranked_bar_chart(
                ...
                single_color=PALETTE[ColorToken.SECONDARY], value_title="Verf\u00fcgbarkeit (%)", bar_height=30,
            )
        )
        streamlit.caption(
        ...
        with chart_cols[0]:
            ...
            streamlit.altair_chart(
                charts.ranked_bar_chart(
                    ...
                    single_color=PALETTE[ColorToken.YELLOW], value_title="MTTR (Min.)", bar_height=26, min_height=180,
                )
            )
        with chart_cols[1]:
            ...
            streamlit.altair_chart(
                charts.ranked_bar_chart(
                    ...
                    single_color=PALETTE[ColorToken.PURPLE], value_title="MTBF (Std.)", bar_height=26, min_height=180,
                )
            )
