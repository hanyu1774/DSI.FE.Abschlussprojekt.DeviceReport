...
class FetchMachines:
    # Was the module-level MACHINES_SELECT in models/selected_machines.py -
    # that violated Plan #1 (a class-independent variable sitting in a
    # models/ file). Nested here since only this one Flow uses it.
    class _Query:
        statement = (
            select(
